    ...
    <div class="sticky top-0 z-10 bg-white border-b border-slate-200 -mx-4 px-4 py-4">
      <div class="flex items-center justify-between mb-3">
        <div class="min-w-0 flex-1">
          <h1 class="heading-2 truncate">{{ t("nav.jobs") }}</h1>
      ...
      <div v-if="jobsStore.completeSuccess || jobsStore.takeSuccess" class="alert alert-success mt-3">
        <div class="font-semibold">{{ t('common.success') }}</div>
    ...
    <div class="py-6">
        ...
        <div v-else class="space-y-3">
          ...
          >
            <div class="flex items-start justify-between gap-4">
              <div class="min-w-0 flex-1">
                <div class="heading-3 truncate">
                  {{ aj.title || t("jobs.unknownTitle") }}
                </div>
                <p class="body-sm mt-1">{{ aj.description || "" }}</p>
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                  ...
                  <span v-if="aj.job_units" class="chip chip-inactive">
                  ...
                  <span v-if="typeof aj.reward_amount === 'number'" class="chip chip-inactive">
      ...
      <div v-else>
        ...
        <div v-else-if="filteredPending.length === 0" class="card p-6">
          ...
          <p class="body-sm mt-2">{{ t("jobs.emptyHint") }}</p>
        </div>
    ...
    >
      <div class="w-full rounded-t-3xl bg-white max-h-[80vh] flex flex-col">
        ...
        <div v-if="pendingJob" class="px-4 py-4 border-b border-slate-200 bg-slate-50">
          ...
          <div class="flex flex-wrap gap-2 mt-3">
            <span v-if="pendingJob.job_units" class="chip chip-inactive">
            ...
            <span v-if="typeof pendingJob.reward_amount === 'number'" class="chip chip-inactive">
        ...
        <div class="divide-y overflow-auto flex-1">
          ...
          >
            <div class="flex items-center justify-between gap-3">
              ...
              <span class="body-sm text-slate-500 shrink-0">{{ v.vehicle_id }}</span>
            </div>
          </button>
...
async function confirmTake(vehicleId: string) {
  ...
  // After taking a job, switch to Active tab
  tab.value = 'active'
}
